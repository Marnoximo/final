...
def main(_):
    ...
    # Copy label-class_id mapping file
    copy(os.path.join(FLAGS.dataset_dir, 'labels.txt'), os.path.join(FLAGS.train_dir, 'labels.txt'))
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            [image, label] = provider.get(['image', 'label_species'])
